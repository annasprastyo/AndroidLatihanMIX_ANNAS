package com.example.androidmix_annas.adapters
...
import com.example.androidmix_annas.widgets.CircleTransform
...
class FriendListAdapter(private val mContext: Context, items: ArrayList<Friend>) : RecyclerView.Adapter<FriendListAdapter.ViewHolder>(),
    ...
    fun setOnItemClikListener(mItemClickListener: OnItemClickListener){
    ...
    private inner class ItemFilter : Filter() {
        override fun performFiltering(constraint: CharSequence): Filter.FilterResults {
            ...
            val result_list = java.util.ArrayList<Friend>(list.size)
